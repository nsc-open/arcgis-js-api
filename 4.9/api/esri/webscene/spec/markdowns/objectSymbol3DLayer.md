...
| Property | Details
| --- | ---
| anchor | The positioning of the object relative to the geometry.<br>If property is present, must be one of the following values: <ul><li>`center`</li><li>`bottom`</li><li>`origin`</li><li>`top`</li></ul>
